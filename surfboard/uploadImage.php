...
// }
  ...
  include 'zzzzz.php';
$result = mysqli_query($con,"SELECT username from users WHERE userID=".$_COOKIE["diresu"]);
...
&& in_array($extension, $allowedExts)) {
  if ($_FILES["file"]["error"] > 0) {
    ...
    $newNamePrefix = time() . '_';
      ...
      "userInfo/" . $row["username"] . "/pics/" . $newNamePrefix . $_FILES["file"]["name"]);
        ...
        // $manipulator->save("userInfo/sgrutman978/pics/" . $_FILES["file"]["name"]);
...
//           $image = imagecreatefromjpeg("userInfo/sgrutman978/pics/" . $_FILES["file"]["name"]);
// $filename = "userInfo/sgrutman978/pics/" . $_FILES["file"]["name"];
// $image->cropImage (20, 30, 50 , 40);
// file_put_contents("userInfo/sgrutman978/pics/" . $_FILES["file"]["name"], $image);
     

  }
}
$url = "userInfo/" . $row["username"] . "/pics/" . $newNamePrefix . $_FILES["file"]["name"];
echo "<img src='$url' style='width:100%;height:100%;position:absolute;top:0px;left:0px'>";
